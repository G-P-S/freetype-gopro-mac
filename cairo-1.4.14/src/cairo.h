...
#pragma warning(disable: 188)	//incorrect enum usage 
#pragma warning(disable: 810)	//64-bit to 32-bit int, potential data loss
#pragma warning(disable: 1786)	//odd stdio calls 
